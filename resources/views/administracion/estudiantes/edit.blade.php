        ...
        <form action="{{route('admin.estudiantes.update',$estudiante->id)}}" method="POST">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <input type="text" class="form-control" id="codigo" name="codigo" value="{{$estudiante->codigo}}">
                    @error('codigo')
            ...
            <div class="row">
             ...
             <div class="mb-3 col-6">
                ...
                <input type="text" class="form-control" id="grado" name="grado" value="{{$estudiante->grado}}">
                @error('grado')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
             ...
             <div class="mb-3 col-6">
                ...
                <input type="text" class="form-control" id="grupo" name="grupo" value="{{$estudiante->grupo}}">
                @error('grupo')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
